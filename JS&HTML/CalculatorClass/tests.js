...
describe('constructor', function () {
    ...
    describe('add function', function () {
        it('add string and numbers', function () {
            ...
            expect(result).to.be.eql(['Pesho', 10, 1.5, -10]);
        });

        it('add objects, array and functions', function () {
    ...
    describe('divide function', function () {
        ...
        it('test with more than two number', function () {
            calculator.add('Pesho');
            calculator.add({});
            calculator.add(-9.9);
            calculator.add(9);
    ...
    describe('orderBy function', function () {
        it('order empty expenses', function () {
